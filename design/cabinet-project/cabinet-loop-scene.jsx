...
function CabinetLoopRoot(){
  ...
  <div style={{width:"100%",height:"100%",minHeight:"480px"}}>
    <CompositionStage width={1600} height={1000} bg="#F1EFE8" scenes={window.OM_SCENES} playback={window.OM_PLAYBACK}>
      <Piece chubby={t.chubby}></Piece>
    </CompositionStage>
    <TweaksPanel>
      ...
      <TweakSlider label="Chubbiness" value={t.chubby} min={0.85} max={1.3} step={0.05} onChange={(v)=>setTweak("chubby",v)}></TweakSlider>
    </TweaksPanel>
  </div>);}
window.CabinetLoopRoot=CabinetLoopRoot;