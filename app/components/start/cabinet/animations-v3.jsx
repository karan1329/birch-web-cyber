...
// Only three changes from source: an explicit React import, a `controls`
// prop so the authoring playback bar stays out of production, and ES
// exports in place of the window global assignment.
  ...
  return (
    ...
    <div
      ...
      style={{
        ...
        alignItems: 'center',
        // Was '#0a0a0a' (authoring stage). On the page the letterbox has to
        // be the artwork's own ground, so it is driven by the background prop.
...
export {
  ...
  Stage, CompositionStage, useComposition, Shot, Captions,
};
